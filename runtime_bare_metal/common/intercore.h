...
#define CORE1_START_ADDRESS 0x10000000u /* Where starts Core1 .ELF */
#define CPU1_START_MEM		0xFFFFFFF0u /* BootROM Mailbox. */
...
struct ocm_mailbox_t {
	...
	volatile uint32_t core1_ready; /* Core1 -> Core0 */
};
...
STATIC_ASSERT( sizeof( struct ocm_mailbox_t ) == 0x14u );
...
STATIC_ASSERT( offsetof( struct ocm_mailbox_t, core1_ready ) == 0x10u );
